---
title: "使用文档"
date: 2021-08-11T10:17:52+08:00
draft: false
weight: 1
---
...
### 投递工具
- \- 先通过Boss的筛选功能圈选出你的意向岗位
- \- <span style="color:red;">投递前在偏好设置中设置您的岗位偏好，便于精准投递。</span>
- \- 批量投递简历。自定义单次投递数量。
- \- 发送自定义招呼语，充分展现您的优势。
- \- 投递后发送图片简历，绕开发送附件简历需要HR同意机制，直接触达。
...
### 视频教程
- \- 点击下方链接观看视频教程。
- \- <a href="https://www.bilibili.com/video/BV1HKAyebESp" style="color:#5fb29f;" target="_blank">AI工作猎手使用教程</a>
